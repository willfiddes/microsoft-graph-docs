...
-->
``` http
POST /admin/windows/updates/deployments/{deploymentId}/audience
```
...
-->
``` http
POST https://graph.microsoft.com/beta/admin/windows/updates/deployments/{deploymentId}/audience
