...
-->
``` http
POST /admin/windows/updates/deployments/{deploymentId}/audience/exclusions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/admin/windows/updates/deployments/{deploymentId}/audience/exclusions
