---
title: "Add user"
description: "Add legacyPendingMembers by posting to the legacyPendingMembers collection."
...
Add legacyPendingMembers by posting to the legacyPendingMembers collection.
...
-->
``` http
POST /groups/{groupsId}/legacyPendingMembers/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/groups/{groupsId}/legacyPendingMembers/$ref
...
{
  "@odata.type": "#microsoft.graph.user",
  "id": "7eb3e260-e260-7eb3-60e2-b37e60e2b37e",
  "deletedDateTime": "String (timestamp)",
  "signInActivity": {
    "@odata.type": "microsoft.graph.signInActivity"
  },
