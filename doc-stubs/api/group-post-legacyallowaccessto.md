---
title: "Add group"
description: "Add legacyAllowAccessTo by posting to the legacyAllowAccessTo collection."
...
Add legacyAllowAccessTo by posting to the legacyAllowAccessTo collection.
...
-->
``` http
POST /groups/{groupsId}/legacyAllowAccessTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/groups/{groupsId}/legacyAllowAccessTo/$ref
